...
public class PaymentController {
    ...
    public ResponseEntity<Map<String, Object>> refundPayment(
        ...
        try {
            ...
            Optional<PaymentTransaction> paymentOpt = paymentTransactionRepository.findByTransactionId(transactionId);
            ...
            Double refundAmount = request.get("amount") != null ? 
                Double.valueOf(request.get("amount").toString()) : payment.getAmount();
            String reason = (String) request.get("reason");
            
            // Update payment status
            payment.setStatus("REFUNDED");
            payment.setFailureReason("Refunded: " + (reason != null ? reason : "No reason provided"));
            paymentTransactionRepository.save(payment);
            
            System.out.println("💰 Refund processed successfully: " + transactionId);
    ...
    public ResponseEntity<Map<String, Object>> cancelPayment(@PathVariable String transactionId) {
        try {
            ...
            System.out.println("🚫 Payment canceled successfully: " + transactionId);
            ...
            return ResponseEntity.internalServerError().body(Map.of(
                "success", false,
                "message", "Error canceling payment: " + e.getMessage()
            ));
        }
    }
}
